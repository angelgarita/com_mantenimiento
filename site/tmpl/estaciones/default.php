		...
		<table class="table table-striped" id="estacionList">
			...
			<?php foreach ($this->items as $i => $item) : ?>
				...
				<tr class="row<?php echo $i % 2; ?>">
                    ...
                    <td class="center">
                        <a href="<?php echo Route::_('index.php?option=com_mantenimiento&view=fotos&est=' . $item->ind_climatologico, false, 2); ?>" class="btn btn-mini" type="button"><i class="fas fa-camera" ></i></a>
                    </td>
                    <?php if ($canEdit || $canDelete): ?>
                    <td class="center">
