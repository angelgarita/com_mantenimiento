    ...
    <table class="table table-borderer">
      <thead>
        <tr>
          ...
          <th scope="col">Estado de la estación</th>
      ...
      <tbody>
        <tr>
          ...
          <td ><img src="<?= Uri::root() ?>media/com_mantenimiento/verde1.png" alt="rojo"></td>
          <td>Estación correcta</td>

        </tr>
        <tr>

          <td><img src="<?= Uri::root() ?>media/com_mantenimiento/amarillo1.png" alt="rojo"></td>
          <td>Estación funcionando con fallos</td>

        </tr>
        <tr>

          <td><img src="<?= Uri::root() ?>media/com_mantenimiento/rojo1.png" alt="rojo"></td>
          <td>Estación con fallos graves</td>
        </tr>
        <tr>

          <td><img src="<?= Uri::root() ?>media/com_mantenimiento/rAmarillo.png" alt="rojo"></td>
          <td>Estación donde falta menos de 1 mes para realizar mantenimiento programado</td>
        </tr>
        <tr>

          <td><img src="<?= Uri::root() ?>media/com_mantenimiento/rRojo.png" alt="rojo"></td>
          <td>Estación con el tiempo programado rebasado</td>
        </tr>
      </tbody>
    </table>
</div>
